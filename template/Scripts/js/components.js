...
function renderHeader(activePage = '') {
  const nav = [
    { label: 'Home', href: 'index.html#page-home', id: 'home' },
    {
      label: 'Destinations', href: 'index.html#page-destinations', id: 'destinations',
      dropdown: [
        { icon: '🏔️', label: 'Himalayas',        href: 'index.html#page-destinations' },
        { icon: '🏖️', label: 'Beaches',           href: 'index.html#page-destinations' },
        { icon: '🏰', label: 'Heritage',          href: 'index.html#page-destinations' },
        { icon: '🌿', label: 'Nature &amp; Wildlife', href: 'index.html#page-destinations' },
        { icon: '🛕', label: 'Spiritual',         href: 'index.html#page-destinations' },
        { icon: '🗺️', label: 'All Destinations',  href: 'index.html#page-destinations' },
      ]
    },
    {
      label: 'Packages', href: 'index.html#page-packages', id: 'packages',
      dropdown: [
        { icon: '👨‍👩‍👧', label: 'Family Trips',  href: 'index.html#page-packages' },
        { icon: '💑',    label: 'Honeymoon',     href: 'index.html#page-packages' },
        { icon: '🧗',    label: 'Adventure',     href: 'index.html#page-packages' },
        { icon: '🧳',    label: 'Solo Travel',   href: 'index.html#page-packages' },
        { icon: '👑',    label: 'Luxury Tours',  href: 'index.html#page-packages' },
        { icon: '📦',    label: 'All Packages',  href: 'index.html#page-packages' },
      ]
    },
    { label: 'Gallery', href: 'index.html#page-gallery', id: 'gallery' },
    { label: 'Blog',    href: 'index.html#page-blog',    id: 'blog'    },
    { label: 'About',   href: 'index.html#page-about',   id: 'about'   },
    { label: 'Contact', href: 'index.html#page-contact', id: 'contact' },
  ];
  ...
  return `
    ...
    <header class="header" role="banner">
      <div class="header-inner">
        <!-- Logo -->
        <a href="index.html#page-home" class="logo" aria-label="Epic-Travellers — Go to Homepage">
        ...
        <div class="header-actions">
          ...
          <a href="index.html#page-dashboard" class="btn btn-secondary btn-sm hide-mobile" aria-label="My Dashboard">My Trips</a>
          <a href="index.html#page-login" class="btn btn-secondary btn-sm" aria-label="Log in to your account">Log In</a>
          <a href="index.html#page-register" class="btn btn-primary btn-sm" aria-label="Register a new account">Register</a>
        </div>
      </div>
    </header>
    ...
    <a href="index.html#page-packages" class="floating-book-btn" aria-label="Book a tour now">
      ...
      <div class="container">
        <div class="footer-grid">
          ...
          <div>
            ...
            <ul class="footer-links">
              <li><a href="index.html#page-home"         class="footer-link">→ Home</a></li>
              <li><a href="index.html#page-about"        class="footer-link">→ About Us</a></li>
              <li><a href="index.html#page-destinations" class="footer-link">→ Destinations</a></li>
              <li><a href="index.html#page-packages"     class="footer-link">→ Tour Packages</a></li>
              <li><a href="index.html#page-gallery"      class="footer-link">→ Photo Gallery</a></li>
              <li><a href="index.html#page-blog"         class="footer-link">→ Travel Blog</a></li>
              <li><a href="index.html#page-contact"      class="footer-link">→ Contact Us</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul class="footer-links">
              <li><a href="index.html#page-destinations" class="footer-link">→ Goa</a></li>
              <li><a href="index.html#page-destinations" class="footer-link">→ Kerala</a></li>
              <li><a href="index.html#page-destinations" class="footer-link">→ Rajasthan</a></li>
              <li><a href="index.html#page-destinations" class="footer-link">→ Ladakh</a></li>
              <li><a href="index.html#page-destinations" class="footer-link">→ Manali</a></li>
              <li><a href="index.html#page-destinations" class="footer-link">→ Andaman</a></li>
              <li><a href="index.html#page-destinations" class="footer-link">→ Varanasi</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul class="footer-links">
              <li><a href="index.html#page-login"    class="footer-link">→ Log In / Sign In</a></li>
              <li><a href="index.html#page-register" class="footer-link">→ Create Account / Register</a></li>
              <li><a href="index.html#page-dashboard"class="footer-link">→ My Dashboard</a></li>
              <li><a href="index.html#page-contact"  class="footer-link">→ Help Center</a></li>
              <li><a href="index.html#page-contact"  class="footer-link">→ Terms & Privacy</a></li>
              <li><a href="index.html#page-contact"  class="footer-link">→ Refund Policy</a></li>
            </ul>
          </div>
        ...
        <div class="footer-bottom">
          ...
          <div class="footer-bottom-links">
            <a href="index.html#page-contact" class="footer-bottom-link">Privacy</a>
            <a href="index.html#page-contact" class="footer-bottom-link">Terms</a>
            <a href="index.html#page-sitemap" class="footer-bottom-link">Sitemap</a>
            <a href="index.html#page-contact" class="footer-bottom-link">Cookies</a>
          </div>
        </div>
      </div>
    </footer>
