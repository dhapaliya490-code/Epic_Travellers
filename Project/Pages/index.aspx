<%@ Page Title="Epic-Travellers – Discover Incredible India | Premium Travel & Tour Packages" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="Epic_Travelers.Pages.index" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
  <meta name="description" content="Epic-Travellers – Discover Incredible India! Book premium tour packages to Goa, Kerala, Rajasthan, Ladakh, Manali & more. Best travel deals, luxury packages, and customized India tours.">
  <meta name="keywords" content="India travel, tour packages, Goa tours, Kerala backwaters, Rajasthan trip, Ladakh adventure, Manali holiday, India travel agency">
  <meta name="author" content="Epic-Travellers">
  <meta property="og:title" content="Epic-Travellers – Discover Incredible India">
  <meta property="og:description" content="Your premium travel partner for exploring the wonders of India. Book customized tours, luxury packages & more.">
  ...
  <style>
    ...
    .hero-slide-1 { background-image: url('../Content/images/img_45.jpg'); }
    .hero-slide-2 { background-image: url('../Content/images/img_23.jpg'); }
    .hero-slide-3 { background-image: url('../Content/images/img_35.jpg'); }
    .hero-slide-4 { background-image: url('../Content/images/img_51.jpg'); }

    .hero-content { padding: 0 24px; padding-top: calc(var(--header-height) + 48px); }
...
<!-- ========== HERO SECTION ========== -->
    <section class="hero" aria-label="Hero banner" id="hero">
      ...
      <div class="hero-particle" style="width:200px;height:200px;background:rgba(14,165,233,0.15);top:10%;left:5%;--duration:8s;--delay:0s;border-radius:50%;filter:blur(40px);" aria-hidden="true"></div>
      <div class="hero-particle" style="width:150px;height:150px;background:rgba(245,158,11,0.12);bottom:20%;right:10%;--duration:6s;--delay:2s;border-radius:50%;filter:blur(30px);" aria-hidden="true"></div>
      ...
      <div class="hero-search">
        <div class="hero-search-inner">
          ...
          <div class="search-box" role="search">
            ...
            <div class="search-divider" aria-hidden="true"></div>
            <div class="search-field">
              <label for="search-checkout"><i class="fa-regular fa-calendar-check" aria-hidden="true"></i> Check Out</label>
            ...
            <div class="search-field">
              ...
              <input type="number" id="search-guests" class="search-input" placeholder="2 Travelers" min="1" max="20" aria-label="Number of guests">
            </div>
            <div class="search-divider" aria-hidden="true"></div>
            <button class="btn btn-primary btn-lg" onclick="window.location.href='/Pages/destinations.aspx'" aria-label="Search destinations">
    ...
    <section class="section" id="destinations" aria-labelledby="destinations-heading" style="padding-top:100px;">
      <div class="container">
        <div class="section-header anim-fade-up">
          <div class="section-label" role="text"><i class="fa-solid fa-map-pin" aria-hidden="true"></i> Popular Destinations</div>
        ...
        <!-- Tags Filter -->
        <div style="display:flex; gap:10px; justify-content:center; flex-wrap:wrap; margin-bottom:40px;" class="anim-fade-up" role="list" aria-label="Destination filters">
        ...
        <div class="destinations-grid stagger-children">
          ...
          <!-- Featured: Rajasthan -->
          <div class="destination-card anim-fade-up" data-category="heritage" style="grid-row:span 2; min-height:440px;">
            ...
            <button class="destination-card-wishlist wishlist-btn" data-id="rajasthan" aria-label="Add Rajasthan to wishlist">
              <i class="fa-regular fa-heart" aria-hidden="true"></i>
            </button>
            <div class="destination-card-content">
              <h3 class="destination-name">Rajasthan</h3>
              <div class="destination-location"><i class="fa-solid fa-location-dot" aria-hidden="true"></i> Jaipur, Udaipur, Jodhpur, Jaisalmer</div>
          ...
          <div class="destination-card anim-fade-up" data-category="beach">
            ...
            <div class="destination-card-content">
              ...
              <div class="destination-location"><i class="fa-solid fa-location-dot" aria-hidden="true"></i> North & South Goa</div>
              <div class="destination-meta">
          ...
          <div class="destination-card anim-fade-up" data-category="nature">
            ...
            <button class="destination-card-wishlist wishlist-btn" data-id="kerala" aria-label="Add Kerala to wishlist">
              <i class="fa-regular fa-heart" aria-hidden="true"></i>
            </button>
            <div class="destination-card-content">
              <h3 class="destination-name">Kerala</h3>
              <div class="destination-location"><i class="fa-solid fa-location-dot" aria-hidden="true"></i> Munnar, Alleppey, Kovalam</div>
              <div class="destination-meta">
          ...
          <div class="destination-card anim-fade-up" data-category="mountains">
            ...
            <button class="destination-card-wishlist wishlist-btn" data-id="ladakh" aria-label="Add Ladakh to wishlist">
              <i class="fa-regular fa-heart" aria-hidden="true"></i>
            </button>
            <div class="destination-card-content">
              <h3 class="destination-name">Ladakh</h3>
              <div class="destination-location"><i class="fa-solid fa-location-dot" aria-hidden="true"></i> Leh, Pangong, Nubra Valley</div>
              <div class="destination-meta">
          ...
          <div class="destination-card anim-fade-up" data-category="beach">
            ...
            <button class="destination-card-wishlist wishlist-btn" data-id="andaman" aria-label="Add Andaman to wishlist">
              <i class="fa-regular fa-heart" aria-hidden="true"></i>
            </button>
            <div class="destination-card-content">
              <h3 class="destination-name">Andaman</h3>
              <div class="destination-location"><i class="fa-solid fa-location-dot" aria-hidden="true"></i> Port Blair, Havelock, Neil</div>
              <div class="destination-meta">
          ...
          <div class="destination-card anim-fade-up" data-category="spiritual">
            ...
            <button class="destination-card-wishlist wishlist-btn" data-id="varanasi" aria-label="Add Varanasi to wishlist">
              <i class="fa-regular fa-heart" aria-hidden="true"></i>
            </button>
            <div class="destination-card-content">
              <h3 class="destination-name">Varanasi</h3>
              <div class="destination-location"><i class="fa-solid fa-location-dot" aria-hidden="true"></i> Ghats, Sarnath, Ramnagar</div>
              <div class="destination-meta">
    ...
    <section class="section" id="packages" aria-labelledby="packages-heading">
      <div class="container">
        <div class="section-header anim-fade-up">
          ...
          <p class="section-subtitle">Curated experiences for every kind of traveller — from luxury retreats to thrilling adventures across India.</p>
        </div>

        <!-- Package Tabs -->
        <div class="tabs anim-fade-up" role="tablist" style="max-width:600px; margin:0 auto 40px;" aria-label="Package categories">
        ...
        <div class="grid grid-3 stagger-children" role="list" aria-label="Tour packages">
          ...
          <article class="package-card anim-fade-up" role="listitem" data-category="heritage luxury">
            <div class="package-card-image">
              <img src="../Content/images/img_48.jpg" alt="Royal Rajasthan tour - Jaipur palaces and deserts" loading="lazy">
          ...
          <article class="package-card anim-fade-up" role="listitem" data-category="adventure mountains">
            <div class="package-card-image">
              <img src="../Content/images/img_14.jpg" alt="Ladakh adventure - Pangong Lake and high-altitude passes" loading="lazy">
              <div class="package-card-badges">
          ...
          <article class="package-card anim-fade-up" role="listitem" data-category="beach family">
            <div class="package-card-image">
              <img src="../Content/images/img_21.jpg" alt="Goa beach holiday - sun, sand and water sports" loading="lazy">
              <div class="package-card-badges">
          ...
          <article class="package-card anim-fade-up" role="listitem" data-category="mountains family">
            <div class="package-card-image">
              <img src="../Content/images/img_43.jpg" alt="Manali Shimla - snow mountains and valleys" loading="lazy">
              <div class="package-card-badges">
          ...
          <article class="package-card anim-fade-up" role="listitem" data-category="beach honeymoon">
            <div class="package-card-image">
              <img src="../Content/images/img_33.jpg" alt="Andaman islands - crystal clear waters and coral reefs" loading="lazy">
              <div class="package-card-badges">
                <span class="badge badge-secondary">💑 Honeymoon</span>
              </div>
            </div>
    ...
    <section class="section" aria-labelledby="why-us-heading">
      <div class="container">
        <div class="section-header anim-fade-up">
          ...
          <h2 class="section-title" id="why-us-heading">Your Journey, <span class="text-gradient">Our Passion</span></h2>
          <p class="section-subtitle">We go above and beyond to make every trip extraordinary — from planning to the last goodbye.</p>
        </div>
        ...
        <div class="grid grid-4 stagger-children" role="list" aria-label="Our features">
          <div class="feature-card anim-fade-up" role="listitem">
            ...
            <p class="feature-desc">Your safety is our priority. All tours are fully insured with 24/7 emergency support.</p>
          </div>
          <div class="feature-card anim-fade-up" role="listitem">
            <div class="feature-icon" aria-hidden="true">💰</div>
            <h3 class="feature-title">Best Price Guarantee</h3>
            <p class="feature-desc">Found a better price? We'll match it! No hidden charges, transparent pricing always.</p>
          </div>
          <div class="feature-card anim-fade-up" role="listitem">
            <div class="feature-icon" aria-hidden="true">⚡</div>
            <h3 class="feature-title">Instant Booking</h3>
            <p class="feature-desc">Book in minutes with our real-time availability system. Get instant confirmation.</p>
          </div>
          <div class="feature-card anim-fade-up" role="listitem">
            <div class="feature-icon" aria-hidden="true">🎯</div>
            <h3 class="feature-title">Customized Trips</h3>
            <p class="feature-desc">Every trip tailored to your preferences. Our experts craft personalized itineraries.</p>
          </div>
          <div class="feature-card anim-fade-up" role="listitem">
            <div class="feature-icon" aria-hidden="true">🌟</div>
          ...
          <div class="feature-card anim-fade-up" role="listitem">
            ...
            <p class="feature-desc">Round-the-clock customer support via chat, call, and email. We're always there.</p>
          </div>
          <div class="feature-card anim-fade-up" role="listitem">
            <div class="feature-icon" aria-hidden="true">🔄</div>
          ...
          <div class="feature-card anim-fade-up" role="listitem">
            ...
            <p class="feature-desc">Our AI suggests personalized itineraries based on your budget and preferences.</p>
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="grid grid-2" style="gap:48px; align-items:center;">
          <div class="anim-fade-left">
            ...
            <p style="font-size:16px; color:var(--text-secondary); line-height:1.8; margin-bottom:24px;">
              Our intelligent trip planner analyzes thousands of routes, hotels, and experiences to create your perfect India itinerary — instantly.
            </p>
            ...
            <div id="ai-planner-form" class="booking-form" novalidate>
              <div class="grid grid-2" style="gap:16px;">
                ...
                <div class="form-group">
                  ...
                  <input type="number" id="ai-duration" name="duration" class="form-control" placeholder="7" min="1" max="30" required>
                </div>
                <div class="form-group">
                  <label class="form-label" for="ai-budget">Budget (₹)</label>
                  <input type="number" id="ai-budget" name="budget" class="form-control" placeholder="50000" min="5000" required>
                </div>
                <div class="form-group">
                  <label class="form-label" for="ai-travelers">Travelers</label>
                  <input type="number" id="ai-travelers" name="travelers" class="form-control" placeholder="2" min="1" required>
                </div>
              </div>
    ...
    <section class="section" aria-labelledby="testimonials-heading">
      <div class="container">
        <div class="section-header anim-fade-up">
          ...
          <h2 class="section-title" id="testimonials-heading">What Our <span class="text-gradient">Travellers Say</span></h2>
        ...
        <div class="testimonials-slider stagger-children" role="list" aria-label="Traveller testimonials">
          ...
          <div class="testimonial-card anim-fade-up" role="listitem">
            ...
            <p class="testimonial-text">
              "Our Rajasthan trip was absolutely magical! Epic-Travellers organized every detail perfectly — from the desert camp in Jaisalmer to the palace hotels in Udaipur. Truly a royal experience!"
            </p>
          ...
          <div class="testimonial-card anim-fade-up" role="listitem">
            <div class="stars" aria-label="5 out of 5 stars">★★★★★</div>
            <p class="testimonial-text">
              "The Ladakh bike tour exceeded all expectations. The team handled permits, accommodation, and even the altitude acclimatization schedule perfectly. Will definitely book again!"
            </p>
            <div class="testimonial-author">
          ...
          <div class="testimonial-card anim-fade-up" role="listitem">
            <div class="stars" aria-label="5 out of 5 stars">★★★★★</div>
            <p class="testimonial-text">
              "Our honeymoon in Kerala was dreamy! The houseboat experience on Alleppey backwaters was unforgettable. Epic-Travellers added so many thoughtful touches. Highly recommend!"
            </p>
            <div class="testimonial-author">
              <img src="../Content/images/img_28.jpg" alt="Ananya & Rohan" class="testimonial-avatar" loading="lazy">
              <div class="testimonial-info">
    ...
    <section class="section" style="background:var(--bg-secondary);" aria-labelledby="blog-heading">
      <div class="container">
        <div class="section-header anim-fade-up">
          ...
          <p class="section-subtitle">Inspiring travel guides, expert tips, and destination insights for your next India adventure.</p>
        </div>
        ...
        <div class="grid grid-3 stagger-children" role="list" aria-label="Travel blog posts">
          ...
          <article class="blog-card anim-fade-up" role="listitem">
            ...
            <div class="blog-card-body">
              ...
              <p style="font-size:14px; color:var(--text-secondary); line-height:1.7; margin-bottom:12px;">
                Discover the best time to visit, must-see sights, altitude tips, and travel hacks for an unforgettable Ladakh adventure.
              </p>
              <div class="blog-meta">
          ...
          <article class="blog-card anim-fade-up" role="listitem">
            ...
            <div class="blog-card-body">
              ...
              <h3 class="blog-card-title">
                <a href="/Pages/blog.aspx">Kerala Backwaters: Why This Houseboat Journey is India's Most Romantic</a>
              </h3>
              <p style="font-size:14px; color:var(--text-secondary); line-height:1.7; margin-bottom:12px;">
                Float through emerald canals on a traditional houseboat as the sun sets over God's Own Country. Pure magic awaits.
              </p>
              <div class="blog-meta">
          ...
          <article class="blog-card anim-fade-up" role="listitem">
            ...
            <div class="blog-card-body">
              ...
              <p style="font-size:14px; color:var(--text-secondary); line-height:1.7; margin-bottom:12px;">
                From the Lake Palace in Udaipur to the Mehrangarh Fort in Jodhpur — Rajasthan's royal architecture is unparalleled.
              </p>
              <div class="blog-meta">
        ...
        <div class="text-center mt-32 anim-fade-up">
          <a href="/Pages/blog.aspx" class="btn btn-secondary btn-lg">Read All Articles <i class="fa-solid fa-arrow-right"></i></a>
        </div>
      </div>
    </section>
    ...
    <section class="cta-section" aria-labelledby="cta-heading">
      ...
      <div class="container" style="position:relative; z-index:2; text-align:center; color:white;">
        <div class="anim-scale">
          ...
          <p style="font-size:18px; color:rgba(255,255,255,0.85); max-width:500px; margin:16px auto 40px; line-height:1.7;">
    ...
    <section class="newsletter-section" aria-labelledby="newsletter-heading">
      <div class="container" style="position:relative; z-index:2; text-align:center; color:white;">
        <div class="anim-fade-up">
          <div class="section-label" style="background:rgba(255,255,255,0.1); border-color:rgba(255,255,255,0.2); color:var(--accent-light); margin:0 auto 16px;">
          ...
          <div class="newsletter-form" style="display:flex; gap:12px; max-width:480px; margin:0 auto;" role="search">
            <input
              type="email"
              name="email"
        ...
        <div class="grid grid-2" style="gap:32px; max-width:800px; margin:0 auto;">
          ...
          <div class="card anim-fade-left" id="currency-converter" style="padding:28px;">
            ...
            <div class="form-group">
              ...
              <input type="number" id="conv-amount" class="form-control" value="1000" aria-label="Amount to convert">
            </div>
            ...
            <div style="background:var(--gradient-primary); border-radius:var(--radius-lg); padding:16px; text-align:center; color:white;">
          ...
          <div class="card anim-fade-right" style="padding:28px;">
            ...
            <div id="checklist" style="display:flex; flex-direction:column; gap:8px; max-height:260px; overflow-y:auto;">
            </div>
          </div>
    ...
    <section class="section" style="background:var(--bg-secondary);" aria-labelledby="partners-heading">
      <div class="container">
        <div class="section-header anim-fade-up">
          ...
          <h2 class="section-title" id="partners-heading">Trusted By <span class="text-gradient">Industry Leaders</span></h2>
        </div>
    ...
    <section class="page-hero">
      <div class="container">
        ...
        <p style="color:rgba(255,255,255,0.85); max-width:600px; margin:0 auto; font-size:16px;">
          Find your next getaway across North, South, East, West, and Central India. Filter by budget, climate, and travel duration.
        </p>
      </div>
    </section>
        ...
        <div class="dest-filter-card anim-fade-up">
          <div id="dest-filter-form" onsubmit="event.preventDefault(); applyDestFilters();">
            <div class="grid grid-4" style="gap:16px;">
              <div>
                <label class="form-label" for="filter-search"><i class="fa-solid fa-magnifying-glass"></i> Search Name</label>
                <input type="text" id="filter-search" class="form-control" placeholder="e.g. Goa, Manali, Jaipur..." oninput="applyDestFilters()">
              </div>
              <div>
              ...
              <div>
                <label class="form-label" for="filter-budget"><i class="fa-solid fa-indian-rupee-sign"></i> Max Budget / Person</label>
      ...
      <div class="container">
        <div class="flex-between mb-32 flex-wrap gap-16">
          ...
          <div style="display:flex; gap:12px; align-items:center;">
            ...
            <select class="form-control filter-select" style="width:auto; padding:8px 16px;" onchange="sortDestinations(this.value)">
        ...
        <div class="grid grid-3 stagger-children" id="destinations-grid-container">
          ...
          <div class="destination-full-card anim-fade-up" data-name="jaipur rajasthan" data-region="north" data-price="15000" data-season="winter" data-rating="4.9">
            <div class="dest-card-img">
              ...
              <button class="destination-card-wishlist wishlist-btn" data-id="dest-jaipur" aria-label="Wishlist Jaipur">
            ...
            <div class="dest-card-body">
              ...
              <div class="dest-info-row">
                ...
                <div class="dest-info-item"><i class="fa-solid fa-star" style="color:var(--accent);"></i> 4.9 (2.4k)</div>
              </div>

              <div style="margin-top:auto; padding-top:16px; border-top:1px solid var(--gray-200);" class="flex-between">
                <div>
          ...
          <!-- Destination 2: Goa -->
          <div class="destination-full-card anim-fade-up" data-name="goa beaches" data-region="west" data-price="8000" data-season="winter" data-rating="4.8">
            <div class="dest-card-img">
            ...
            <div class="dest-card-body">
              ...
              <div class="dest-info-row">
                ...
                <div class="dest-info-item"><i class="fa-solid fa-star" style="color:var(--accent);"></i> 4.8 (3.8k)</div>
              </div>
          ...
          <div class="destination-full-card anim-fade-up" data-name="kerala munnar alleppey" data-region="south" data-price="12000" data-season="winter" data-rating="4.9">
            <div class="dest-card-img">
              <img src="../Content/images/img_55.jpg" alt="Kerala Munnar" loading="lazy">
              <div style="position:absolute; top:12px; left:12px;">
                <span class="badge badge-secondary">🌿 Backwaters & Tea</span>
              </div>
              <button class="destination-card-wishlist wishlist-btn" data-id="dest-kerala" aria-label="Wishlist Kerala">
                <i class="fa-regular fa-heart"></i>
              </button>
            </div>
            <div class="dest-card-body">
              ...
              <div class="dest-info-row">
                ...
                <div class="dest-info-item"><i class="fa-solid fa-star" style="color:var(--accent);"></i> 4.9 (3.1k)</div>
              </div>
          ...
          <div class="destination-full-card anim-fade-up" data-name="leh ladakh pangong" data-region="north" data-price="22000" data-season="summer" data-rating="4.9">
            <div class="dest-card-img">
              <img src="../Content/images/img_14.jpg" alt="Leh Ladakh" loading="lazy">
              <div style="position:absolute; top:12px; left:12px;">
                <span class="badge badge-dark">🏔️ High Altitude</span>
              </div>
              <button class="destination-card-wishlist wishlist-btn" data-id="dest-ladakh" aria-label="Wishlist Ladakh">
                <i class="fa-regular fa-heart"></i>
              </button>
            </div>
            <div class="dest-card-body">
              ...
              <div class="dest-info-row">
                ...
                <div class="dest-info-item"><i class="fa-solid fa-star" style="color:var(--accent);"></i> 4.9 (2.1k)</div>
              </div>
          ...
          <div class="destination-full-card anim-fade-up" data-name="andaman havelock port blair" data-region="islands" data-price="20000" data-season="winter" data-rating="4.8">
            <div class="dest-card-img">
              <img src="../Content/images/img_33.jpg" alt="Havelock Andaman" loading="lazy">
              <div style="position:absolute; top:12px; left:12px;">
                <span class="badge badge-primary">🏝️ Tropical Island</span>
              </div>
              <button class="destination-card-wishlist wishlist-btn" data-id="dest-andaman" aria-label="Wishlist Andaman">
                <i class="fa-regular fa-heart"></i>
              </button>
            </div>
            <div class="dest-card-body">
              ...
              <div class="dest-info-row">
                ...
                <div class="dest-info-item"><i class="fa-solid fa-star" style="color:var(--accent);"></i> 4.8 (1.6k)</div>
              </div>
          ...
          <div class="destination-full-card anim-fade-up" data-name="manali solang Himachal" data-region="north" data-price="14000" data-season="summer" data-rating="4.8">
            <div class="dest-card-img">
              <img src="../Content/images/img_43.jpg" alt="Manali Himachal" loading="lazy">
              <div style="position:absolute; top:12px; left:12px;">
                <span class="badge badge-secondary">⛰️ Hill Station</span>
              </div>
              <button class="destination-card-wishlist wishlist-btn" data-id="dest-manali" aria-label="Wishlist Manali">
                <i class="fa-regular fa-heart"></i>
              </button>
            </div>
            <div class="dest-card-body">
              ...
              <div class="dest-info-row">
                ...
                <div class="dest-info-item"><i class="fa-regular fa-clock"></i> 5-7 Days</div>
                <div class="dest-info-item"><i class="fa-solid fa-star" style="color:var(--accent);"></i> 4.8 (2.9k)</div>
              </div>
          ...
          <div class="destination-full-card anim-fade-up" data-name="varanasi kashi ghats" data-region="north" data-price="7000" data-season="winter" data-rating="4.7">
            <div class="dest-card-img">
              <img src="../Content/images/img_41.jpg" alt="Varanasi Ghats" loading="lazy">
              <div style="position:absolute; top:12px; left:12px;">
                <span class="badge badge-accent">🛕 Spiritual Heart</span>
              </div>
              <button class="destination-card-wishlist wishlist-btn" data-id="dest-varanasi" aria-label="Wishlist Varanasi">
                <i class="fa-regular fa-heart"></i>
              </button>
            </div>
            <div class="dest-card-body">
              ...
              <p style="font-size:14px; color:var(--text-secondary); line-height:1.6; margin-bottom:16px;">
                World's oldest living city. Evening Ganga Aarti, sunrise boat rides on sacred river ghats, and ancient alleys.
              </p>

              <div class="dest-info-row">
                <div class="dest-info-item"><i class="fa-regular fa-calendar"></i> Best: Oct - Mar</div>
                <div class="dest-info-item"><i class="fa-regular fa-clock"></i> 3-4 Days</div>
                <div class="dest-info-item"><i class="fa-solid fa-star" style="color:var(--accent);"></i> 4.7 (2.2k)</div>
              </div>
          ...
          <div class="destination-full-card anim-fade-up" data-name="darjeeling sikkim gangtok" data-region="east" data-price="16000" data-season="summer" data-rating="4.8">
            <div class="dest-card-img">
              ...
              <button class="destination-card-wishlist wishlist-btn" data-id="dest-darjeeling" aria-label="Wishlist Darjeeling">
                <i class="fa-regular fa-heart"></i>
              </button>
            </div>
            <div class="dest-card-body">
              ...
              <p style="font-size:13px; color:var(--text-secondary); margin-bottom:8px;">
                <i class="fa-solid fa-location-dot" style="color:var(--primary);"></i> West Bengal / Sikkim, East India
              </p>
              <p style="font-size:14px; color:var(--text-secondary); line-height:1.6; margin-bottom:16px;">
                View of Mount Kanchenjunga, UNESCO Toy Train ride, aromatic tea gardens, and peaceful Buddhist monasteries.
              </p>

              <div class="dest-info-row">
                <div class="dest-info-item"><i class="fa-regular fa-calendar"></i> Best: Mar - May, Oct - Dec</div>
                <div class="dest-info-item"><i class="fa-regular fa-clock"></i> 6-8 Days</div>
                <div class="dest-info-item"><i class="fa-solid fa-star" style="color:var(--accent);"></i> 4.8 (1.9k)</div>
              </div>
          ...
          <div class="destination-full-card anim-fade-up" data-name="coorg mysore karnataka" data-region="south" data-price="10000" data-season="winter" data-rating="4.8">
            <div class="dest-card-img">
              <img src="../Content/images/img_14.jpg" alt="Coorg Coffee Estate" loading="lazy">
              <div style="position:absolute; top:12px; left:12px;">
                <span class="badge badge-primary">☕ Coffee Capital</span>
              </div>
              <button class="destination-card-wishlist wishlist-btn" data-id="dest-coorg" aria-label="Wishlist Coorg">
                <i class="fa-regular fa-heart"></i>
              </button>
            </div>
            <div class="dest-card-body">
              ...
              <p style="font-size:14px; color:var(--text-secondary); line-height:1.6; margin-bottom:16px;">
                Scotland of India. Misty coffee plantations, waterfalls, grand Mysore Palace, and wildlife sanctuaries.
              </p>

              <div class="dest-info-row">
                <div class="dest-info-item"><i class="fa-regular fa-calendar"></i> Best: Oct - Mar</div>
                <div class="dest-info-item"><i class="fa-regular fa-clock"></i> 4-5 Days</div>
                <div class="dest-info-item"><i class="fa-solid fa-star" style="color:var(--accent);"></i> 4.8 (1.7k)</div>
              </div>
    ...
    <section class="section" style="background:var(--bg-secondary);">
      <div class="container">
        <div class="section-header anim-fade-up">
          ...
          <p class="section-subtitle">Click on pins on our map to jump directly to regional packages and destination highlights.</p>
        </div>
        ...
        <div class="map-container anim-scale">
          <div class="simulated-map">
            ...
            <!-- Pin: Ladakh -->
            <div class="map-pin" style="top: 15%; left: 32%;" onclick="window.location.href='/Pages/package-details.aspx?id=ladakh-adventure'">
              <i class="fa-solid fa-mountain"></i>
              <div class="map-pin-tooltip">Ladakh (Leh)</div>
            </div>

            <!-- Pin: Manali -->
            <div class="map-pin" style="top: 25%; left: 35%;" onclick="window.location.href='/Pages/package-details.aspx?id=manali-shimla'">
              <i class="fa-solid fa-snowflake"></i>
              <div class="map-pin-tooltip">Manali & Shimla</div>
            </div>

            <!-- Pin: Rajasthan -->
            <div class="map-pin" style="top: 40%; left: 25%;" onclick="window.location.href='/Pages/package-details.aspx?id=royal-rajasthan'">
              <i class="fa-solid fa-chess-rook"></i>
              <div class="map-pin-tooltip">Rajasthan (Jaipur)</div>
            </div>

            <!-- Pin: Goa -->
            <div class="map-pin" style="top: 68%; left: 28%;" onclick="window.location.href='/Pages/package-details.aspx?id=goa-beach'">
              <i class="fa-solid fa-umbrella-beach"></i>
              <div class="map-pin-tooltip">Goa Beaches</div>
            </div>

            <!-- Pin: Kerala -->
            <div class="map-pin" style="top: 85%; left: 34%;" onclick="window.location.href='/Pages/package-details.aspx?id=kerala'">
              <i class="fa-solid fa-ship"></i>
              <div class="map-pin-tooltip">Kerala Backwaters</div>
            </div>

            <!-- Pin: Andaman -->
            <div class="map-pin" style="top: 75%; left: 82%;" onclick="window.location.href='/Pages/package-details.aspx?id=andaman'">
              <i class="fa-solid fa-water"></i>
              <div class="map-pin-tooltip">Andaman Islands</div>
            </div>

            <div style="position:absolute; bottom:20px; right:20px; background:rgba(255,255,255,0.9); padding:10px 16px; border-radius:var(--radius-md); font-size:12px; font-weight:600; color:var(--text-primary); backdrop-filter:blur(10px);">
        ...
        <div class="grid grid-3 stagger-children" id="packages-grid">
          ...
          <article class="package-card anim-fade-up" data-title="royal rajasthan expedition" data-style="luxury" data-days="8" data-price="25000">
            <div class="package-card-image">
              ...
              <button class="destination-card-wishlist wishlist-btn" data-id="pkg-rajasthan" aria-label="Wishlist Royal Rajasthan">
                <i class="fa-regular fa-heart"></i>
              </button>
            </div>
            <div class="package-card-body">
          ...
          <article class="package-card anim-fade-up" data-title="kerala backwaters honeymoon" data-style="honeymoon" data-days="6" data-price="18000">
            <div class="package-card-image">
              ...
              <button class="destination-card-wishlist wishlist-btn" data-id="pkg-kerala" aria-label="Wishlist Kerala">
                <i class="fa-regular fa-heart"></i>
              </button>
            </div>
            <div class="package-card-body">
          ...
          <article class="package-card anim-fade-up" data-title="ladakh bike adventure" data-style="adventure" data-days="10" data-price="32000">
            <div class="package-card-image">
              ...
              <button class="destination-card-wishlist wishlist-btn" data-id="pkg-ladakh" aria-label="Wishlist Ladakh">
                <i class="fa-regular fa-heart"></i>
              </button>
            </div>
            <div class="package-card-body">
          ...
          <article class="package-card anim-fade-up" data-title="manali shimla snow solo group" data-style="solo" data-days="7" data-price="16000">
            <div class="package-card-image">
              ...
              <button class="destination-card-wishlist wishlist-btn" data-id="pkg-manali" aria-label="Wishlist Manali">
                <i class="fa-regular fa-heart"></i>
              </button>
            </div>
            <div class="package-card-body">
          ...
          <article class="package-card anim-fade-up" data-title="andaman island escape luxury" data-style="luxury" data-days="6" data-price="22000">
            <div class="package-card-image">
              ...
              <button class="destination-card-wishlist wishlist-btn" data-id="pkg-andaman" aria-label="Wishlist Andaman">
                <i class="fa-regular fa-heart"></i>
              </button>
            </div>
            <div class="package-card-body">
    ...
    <section class="section" style="background:linear-gradient(135deg, #0f172a 0%, #1e293b 100%); color:white;">
      <div class="container text-center">
        <div class="anim-fade-up">
          ...
          <a href="#page-contact" class="btn btn-primary btn-lg">Request Custom Itinerary <i class="fa-solid fa-paper-plane"></i></a>
        </div>
      </div>
    </section>
</div>
...
<div class="container section">
      ...
      <div class="flex-between flex-wrap gap-16 mb-24">
        ...
        <div style="display:flex; gap:12px; align-items:center;">
          ...
          <button class="btn btn-glass btn-sm" style="color:var(--text-primary); border-color:var(--gray-300);" onclick="navigator.share ? navigator.share({title: document.title, url: window.location.href}) : alert('URL copied!')">
        ...
        <div class="featured-blog-card mb-48 anim-fade-up">
          ...
          <div style="padding:32px; display:flex; flex-direction:column; justify-content:center;">
            ...
            <h2 style="font-size:24px; font-weight:800; line-height:1.3; margin-bottom:12px;">
              <a href="#" style="color:var(--text-primary);">The Ultimate Ladakh Biking Expedition Guide 2025</a>
            </h2>
            ...
            <a href="#" class="btn btn-primary btn-sm" style="width:max-content;">Read Full Story <i class="fa-solid fa-arrow-right"></i></a>
          </div>
        </div>
            ...
            <div class="grid grid-2 stagger-children" id="blog-articles-grid">
              ...
              <article class="blog-card anim-fade-up">
                ...
                <div class="blog-card-body">
                  ...
                  <h3 class="blog-card-title"><a href="#">Kerala Backwaters: Houseboat Cruise Experience</a></h3>
              ...
              <article class="blog-card anim-fade-up">
                <div class="blog-card-image">
                  <img src="../Content/images/img_48.jpg" alt="Rajasthan palaces" loading="lazy">
                </div>
                <div class="blog-card-body">
                  <span class="blog-category">Heritage & Palaces</span>
                  <h3 class="blog-card-title"><a href="#">10 Forts in Rajasthan That Transport You Back in Time</a></h3>
                  <p style="font-size:13px; color:var(--text-secondary); line-height:1.6; margin-bottom:12px;">
              ...
              <article class="blog-card anim-fade-up">
                ...
                <div class="blog-card-body">
                  ...
                  <h3 class="blog-card-title"><a href="#">Beyond Beaches: Hidden Secret Spots in South Goa</a></h3>
                  <p style="font-size:13px; color:var(--text-secondary); line-height:1.6; margin-bottom:12px;">
              ...
              <article class="blog-card anim-fade-up">
                ...
                <div class="blog-card-body">
                  ...
                  <h3 class="blog-card-title"><a href="#">A Spiritual Morning in Varanasi: Boat Ride & Ganga Aarti</a></h3>
                  <p style="font-size:13px; color:var(--text-secondary); line-height:1.6; margin-bottom:12px;">
...
<!-- Hero Header -->
    ...
    <div class="lightbox-modal" id="lightbox" onclick="closeLightbox()">
      <button style="position:absolute; top:20px; right:20px; color:white; font-size:36px; background:none; border:none; cursor:pointer; z-index:1; line-height:1;" onclick="closeLightbox()">&times;</button>
      <div class="lightbox-content" onclick="event.stopPropagation()">
        <img id="lightbox-img" src="" alt="Full size photo preview">
        <div style="background:var(--bg-primary); padding:16px; text-align:center; color:var(--text-primary); font-weight:700; font-size:15px;" id="lightbox-caption"></div>
      </div>
    </div>
</div>
      ...
      <div class="container">
        ...
        <div class="grid grid-2" style="gap:40px; align-items:start;">
          ...
          <div class="card p-32 anim-fade-left" style="padding:32px;">
            ...
            <div id="contact-form" onsubmit="event.preventDefault(); Toast.show('Message sent successfully! We\'ll reply shortly. 📩', 'success'); this.reset();">
              <div class="grid grid-2" style="gap:16px;">
                <div class="form-group">
...
<div class="dashboard-layout">
      ...
      <aside class="dashboard-sidebar anim-fade-left">
        <div style="text-align:center; padding-bottom:20px; border-bottom:1px solid var(--gray-200); margin-bottom:20px;">
          <img src="../Content/images/img_27.jpg" style="width:80px; height:80px; border-radius:50%; object-fit:cover; margin-bottom:12px; border:3px solid var(--primary);" alt="User Profile Avatar">
          <h3 style="font-size:18px; font-weight:700;">Aisha Patel</h3>
          <span class="badge badge-primary">⭐ Gold Explorer</span>
        </div>

        <nav style="display:flex; flex-direction:column;">
          <a class="dash-menu-item active" onclick="showTab('tab-bookings', this)"><i class="fa-solid fa-suitcase"></i> My Bookings</a>
          <a class="dash-menu-item" onclick="showTab('tab-wishlist', this)"><i class="fa-solid fa-heart"></i> Saved Wishlist</a>
          <a class="dash-menu-item" onclick="showTab('tab-payments', this)"><i class="fa-solid fa-receipt"></i> Payment History</a>
          <a class="dash-menu-item" onclick="showTab('tab-profile', this)"><i class="fa-solid fa-user-gear"></i> Profile Settings</a>
          <a class="dash-menu-item" href="#page-auth" style="color:#EF4444;"><i class="fa-solid fa-right-from-bracket"></i> Sign Out</a>
        </nav>
      </aside>
      ...
      <section class="anim-fade-right">
        ...
        <div id="tab-bookings" class="dash-tab-content">
          <div class="flex-between mb-24">
            <div>
              ...
              <p style="font-size:14px; color:var(--text-secondary);">Manage your upcoming and past travel itineraries</p>
            </div>
          ...
          <div class="booking-history-card">
            <img src="../Content/images/img_46.jpg" style="width:140px; height:100px; border-radius:var(--radius-lg); object-fit:cover;" alt="Royal Rajasthan">
            <div style="flex:1;">
              <div class="flex-between mb-4">
                <h3 style="font-size:17px; font-weight:700;">Royal Rajasthan Expedition</h3>
                <span class="badge badge-success">✓ Confirmed</span>
              </div>
              <p style="font-size:13px; color:var(--text-secondary);"><i class="fa-regular fa-calendar"></i> Oct 15 – Oct 22, 2025 (8 Days)</p>
              <p style="font-size:13px; color:var(--text-secondary);"><i class="fa-solid fa-ticket"></i> Booking ID: #EPIC-89210 • 2 Adults</p>
            </div>
            <div style="text-align:right;">
              <strong style="font-size:18px; color:var(--primary);" data-price-inr="45000">₹45,000</strong>
              <div style="margin-top:8px;">
                <button class="btn btn-secondary btn-sm" onclick="window.print()"><i class="fa-solid fa-file-pdf"></i> Invoice</button>
              </div>
            </div>
          </div>
          ...
          <!-- Active Booking 2 -->
          <div class="booking-history-card">
            <img src="../Content/images/img_52.jpg" style="width:140px; height:100px; border-radius:var(--radius-lg); object-fit:cover;" alt="Kerala Backwaters">
            <div style="flex:1;">
              <div class="flex-between mb-4">
                <h3 style="font-size:17px; font-weight:700;">Kerala Backwaters Romantic Bliss</h3>
                <span class="badge badge-primary">⏳ Upcoming</span>
              </div>
              <p style="font-size:13px; color:var(--text-secondary);"><i class="fa-regular fa-calendar"></i> Dec 05 – Dec 11, 2025 (6 Days)</p>
              <p style="font-size:13px; color:var(--text-secondary);"><i class="fa-solid fa-ticket"></i> Booking ID: #EPIC-94102 • 2 Adults</p>
            </div>
            <div style="text-align:right;">
        ...
        <div id="tab-wishlist" class="dash-tab-content" style="display:none;">
          ...
          <div class="grid grid-2" style="gap:20px;">
            <div class="card p-16 flex" style="gap:16px; padding:16px;">
              <img src="../Content/images/img_11.jpg" style="width:100px; height:80px; border-radius:var(--radius-md); object-fit:cover;" alt="Ladakh">
              <div style="flex:1;">
            ...
            <table style="width:100%; border-collapse:collapse; font-size:14px;">
              ...
              <tbody>
                <tr style="border-bottom:1px solid var(--gray-200);">
                  ...
                  <td style="padding:10px;"><button class="btn btn-secondary btn-sm" onclick="window.print()">Download</button></td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <div id="tab-profile" class="dash-tab-content" style="display:none;">
          ...
          <div class="card p-24" style="padding:28px;" onsubmit="event.preventDefault(); Toast.show('Profile updated successfully! 👤', 'success');">
            <div class="grid grid-2" style="gap:16px;">
              <div class="form-group">
...
<div id="page-auth" class="spa-page" style="display:none;">
  <div class="auth-container">
    <div class="auth-card anim-scale">
      ...
      <!-- Login Form -->
      <div id="login-form" onsubmit="event.preventDefault(); Toast.show('Welcome back! Logging you in... 🚀', 'success'); setTimeout(() => window.location.href='#page-dashboard', 1500);">
      ...
      <!-- Register Form -->
      <div id="register-form" style="display:none;" onsubmit="event.preventDefault(); Toast.show('Account created successfully! Welcome aboard ✈️', 'success'); setTimeout(() => window.location.href='#page-dashboard', 1500);">
        <div class="text-center mb-24">
...
<div id="page-login" class="spa-page" style="display:none;">
  <div class="auth-container">
    <div class="auth-card anim-scale">
      ...
      <div id="standalone-login-form" onsubmit="event.preventDefault(); Toast.show('Welcome back! Logging you in... 🚀', 'success'); setTimeout(() => window.location.href='#page-dashboard', 1500);">
        <div class="form-group">
      ...
      <div class="text-center mt-24" style="font-size:14px; color:var(--text-secondary);">
        Don't have an account? <a href="#page-register" style="color:var(--primary); font-weight:600;">Create Account</a>
      </div>
    </div>
  </div>
</div>
...
<div id="page-register" class="spa-page" style="display:none;">
  <div class="auth-container">
    <div class="auth-card anim-scale">
      ...
      <div id="standalone-register-form" onsubmit="event.preventDefault(); Toast.show('Account created successfully! Welcome aboard ✈️', 'success'); setTimeout(() => window.location.href='#page-dashboard', 1500);">
        <div class="form-group">
...
<div id="page-admin" class="spa-page" style="display:none;">
  <div class="admin-layout">
    ...
    <!-- Admin Sidebar -->
    <aside class="admin-sidebar" style="background:#0f172a; color:white; padding:24px 16px; padding-top:calc(var(--header-height) + 24px); min-height:100vh;">
      ...
      <nav style="display:flex; flex-direction:column;">
        <a class="admin-menu-link active" style="display:flex; align-items:center; gap:12px; padding:12px 16px; border-radius:var(--radius-md); font-size:14px; color:rgba(255,255,255,0.8); cursor:pointer; margin-bottom:4px; background:var(--gradient-primary);" onclick="switchAdminTab('tab-overview', this)"><i class="fa-solid fa-chart-line"></i> Overview</a>
        <a class="admin-menu-link" style="display:flex; align-items:center; gap:12px; padding:12px 16px; border-radius:var(--radius-md); font-size:14px; color:rgba(255,255,255,0.6); cursor:pointer; margin-bottom:4px; transition:all 0.2s;" onclick="switchAdminTab('admin-tab-bookings', this)"><i class="fa-solid fa-suitcase"></i> Bookings (1,420)</a>
        <a class="admin-menu-link" style="display:flex; align-items:center; gap:12px; padding:12px 16px; border-radius:var(--radius-md); font-size:14px; color:rgba(255,255,255,0.6); cursor:pointer; margin-bottom:4px; transition:all 0.2s;" onclick="switchAdminTab('admin-tab-packages', this)"><i class="fa-solid fa-box"></i> Manage Packages</a>
        <a class="admin-menu-link" style="display:flex; align-items:center; gap:12px; padding:12px 16px; border-radius:var(--radius-md); font-size:14px; color:rgba(255,255,255,0.6); cursor:pointer; margin-bottom:4px; transition:all 0.2s;" onclick="switchAdminTab('admin-tab-destinations', this)"><i class="fa-solid fa-location-dot"></i> Destinations</a>
        <a class="admin-menu-link" style="display:flex; align-items:center; gap:12px; padding:12px 16px; border-radius:var(--radius-md); font-size:14px; color:rgba(255,255,255,0.6); cursor:pointer; margin-bottom:4px; transition:all 0.2s;" onclick="switchAdminTab('admin-tab-users', this)"><i class="fa-solid fa-users"></i> Users (52.4k)</a>
        <hr style="border:none; border-top:1px solid rgba(255,255,255,0.1); margin:16px 0;">
        <a href="#page-home" class="admin-menu-link" style="display:flex; align-items:center; gap:12px; padding:12px 16px; border-radius:var(--radius-md); font-size:14px; color:rgba(255,100,100,0.8); cursor:pointer;"><i class="fa-solid fa-arrow-left"></i> Back to Website</a>
      </nav>
    </aside>

    <!-- Admin Main Content -->
    <main style="padding:32px; background:var(--bg-secondary); padding-top:calc(var(--header-height) + 32px); min-height:100vh; overflow-y:auto;">
      ...
      <div id="tab-overview" class="admin-tab-panel">
        <div class="flex-between mb-32">
          ...
          <button class="btn btn-primary btn-sm" onclick="Toast.show('Report downloaded!', 'success')"><i class="fa-solid fa-download"></i> Export Report</button>
        </div>
        ...
        <div class="card p-24" style="padding:24px;">
          ...
          <div style="overflow-x:auto;">
            <table style="width:100%; border-collapse:collapse; font-size:14px;">
              <thead>
                <tr style="text-align:left; border-bottom:2px solid var(--gray-200); background:var(--bg-secondary);">
      ...
      <div id="admin-tab-bookings" class="admin-tab-panel" style="display:none;">
        ...
        <p style="color:var(--text-secondary); margin-top:8px;">Full list of 1,420 bookings with status controls.</p>
      </div>
</div>
...
<div class="container" style="max-width:600px;">
      <div class="anim-scale">
        ...
        <div style="display:flex; gap:16px; justify-content:center; flex-wrap:wrap;">
          ...
          <a href="#page-destinations" class="btn btn-secondary btn-lg"><i class="fa-solid fa-compass"></i> Explore Destinations</a>
        </div>
      </div>
    </div>
</div>
