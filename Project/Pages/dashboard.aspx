    ...
    <div class="dashboard-layout">
      ...
      <aside class="dashboard-sidebar anim-fade-left">
        ...
        <nav style="display:flex; flex-direction:column;">
          ...
          <a class="dash-menu-item" href="/Pages/auth.aspx" style="color:#EF4444;"><i class="fa-solid fa-right-from-bracket"></i> Sign Out</a>
        </nav>
      </aside>
      ...
      <section class="anim-fade-right">
          ...
          <div class="booking-history-card">
            ...
            <div style="text-align:right;">
              ...
              <div style="margin-top:8px;">
                <button type="button" class="btn btn-secondary btn-sm" onclick="window.print()"><i class="fa-solid fa-file-pdf"></i> Invoice</button>
              </div>
            </div>
          </div>
          ...
          <div class="grid grid-2" style="gap:20px;">
            <div class="card p-16 flex" style="gap:16px; padding:16px;">
              ...
              <div style="flex:1;">
                ...
                <a href="/Pages/package-details.aspx?id=ladakh-adventure" class="btn btn-primary btn-sm mt-8">Book Now</a>
              </div>
            </div>
          </div>
        </div>
            ...
            <table style="width:100%; border-collapse:collapse; font-size:14px;">
              ...
              <tbody>
                <tr style="border-bottom:1px solid var(--gray-200);">
                  ...
                  <td style="padding:10px;"><button type="button" class="btn btn-secondary btn-sm" onclick="window.print()">Download</button></td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <div id="tab-profile" class="dash-tab-content" style="display:none;">
          ...
          <div class="card p-24" style="padding:28px;" onsubmit="event.preventDefault(); Toast.show('Profile updated successfully! 👤', 'success');">
            ...
            <button type="button" onclick="Toast.show('Profile updated successfully! 👤', 'success');" class="btn btn-primary mt-16">Save Changes</button>
          </div>
        </div>
